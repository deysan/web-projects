...
// Polyphil for Object-fit
window.objectFitImages();

// Menu Code
// Adds classes for the correct display of a closed menu
...
// Adds classes for the correct display of the open menu
...
// Slider a code
// Assembly of the Slider a object
for (var i = 0; i < sliders.length; i++) {
  ...
  slider.step =
    ...
    sliders[i].querySelectorAll('.slider__item--hide').length;
...
// Initialization and logic of the slider
slidersList.forEach(function (el) {
  ...
  function openSlides(n) {
    ...
    slideIndex -= el.step;
    el.slides[0].style.marginLeft =
      '-' + (MAX_PERCENT / el.slides.length) * slideIndex + '%';
    slideIndex += el.step;
  }
...
if (map) {
  ...
  var init = function () {
    ...
    var myPlacemark = new window.ymaps.Placemark(
      mapCoord,
      {
        hintContent: 'Hey, we are here!',
        balloonContent: 'Education Centre Clever Baby',
      },
      {
